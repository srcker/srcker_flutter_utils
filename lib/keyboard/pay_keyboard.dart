...
class PayKeyBoard extends StatefulWidget {
    ...
    @override
    _PayKeyBoardState createState() => _PayKeyBoardState();
}

/// 键盘对话框的状态类，管理键盘的显示和行为
class _PayKeyBoardState extends State<PayKeyBoard> {
    ...
    Widget buildKeyboardItem(KeyBoardData keyBoardData, BuildContext context) {
        return GestureDetector(
            ...
            child: Container(
                // 按钮的视觉样式
                width: keyBoardData.value == "0"?(MediaQuery.of(context).size.width - 40) / 2 + 5: (MediaQuery.of(context).size.width - 50) / 4,
